...
const notificationMapping: Record<string, NotificationConfigInterface> = {
  'order.create': {
    roles: ['restaurant-manager', 'restaurant-owner'],
    key: 'new-customer-order',
    tenantPath: ['startup', 'restaurant', 'order'],
    userPath: [],
  },
  'order.update': {
    roles: ['restaurant-manager', 'restaurant-owner', 'customer'],
  ...
  'reservation.create': {
    roles: ['restaurant-manager', 'restaurant-owner'],
    key: 'new-reservation',
    tenantPath: ['startup', 'restaurant', 'reservation'],
    userPath: [],
  },
};
...
const tenantRoles: string[] = ['restaurant-owner', 'restaurant-manager', 'delivery-driver'];
